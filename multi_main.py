...
if __name__ == '__main__':
    ...
    parser.add_argument('--cpu', action='store_true', help='flag of testing')


    opts = parser.parse_args()

    debug = opts.no_debug
    device = torch.device('cuda' if (not opts.cpu and torch.cuda.is_available()) else 'cpu')
    ...
    if args.split_flag:
        ...
        split_data(traj_input_dir, output_dir, raw2new_rid_dict)

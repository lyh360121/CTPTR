...
def load_rn_dict(dir, file_name):
    ...
    candi_highway_types = {'motorway': 1, 'trunk': 2, 'primary': 3, 'secondary':4, 'tertiary':5, 'unclassified':6,
                                    'residential':7, 'motorway_link':8, 'trunk_link':9, 'primary_link':10, 'secondary_link':11,
                                    'tertiary_link':12, 'living_street':13, 'service':14, 'road':15}
    new_rn_dict = {}
